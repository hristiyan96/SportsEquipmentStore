    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Global leader in sportswear", "Nike" },
                    { 2, "Innovative and comfortable gear", "Adidas" },
                    { 3, "Performance and lifestyle products", "Puma" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Treadmills, weights, etc.", "Fitness Equipment" },
                    { 2, "Football, cricket, etc.", "Outdoor Sports" },
                    { 3, "Kayaks, surfing boards, etc.", "Water Sports" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "BrandId", "Description", "ImageUrl", "Name", "Price", "SportCategory" },
                values: new object[,]
                {
                    { 1, 1, "Top running shoes.", "/images/nike_air_zoom.jpg", "Nike Air Zoom", 120.99m, "Running" },
                    { 2, 2, "High-performance running shoes.", "/images/adidas_ultraboost.jpg", "Adidas Ultraboost", 130.50m, "Running" },
                    { 3, 3, "Durable sports backpack.", "/images/puma_backpack.jpg", "Puma Backpack", 49.99m, "Accessories" }
                });
